...
const mockIssueSearchFetch = vi.fn(() =>
    Promise.resolve({
        items: [],
        totalCount: 0,
        hasNextPage: false,
...
describe("IssueList", () => {
    ...
    it("renders tab buttons: Open and Closed (no Merged)", () => {
        renderList();
        expect(
    ...
    it("renders header links: Labels, Milestones (no New Pull Request)", () => {
        renderList();
        expect(
