...
export function ReviewStatusBadges({
    ...
    return (
        <div className="flex flex-wrap items-center gap-1.5">
            {requiredApprovalCount > 0 && (
                <div
                    className={`flex items-center gap-1.5 rounded-md border px-3 py-2 font-medium text-sm ${
            ...
            {changesRequestedCount > 0 && (
                <div className="flex items-center gap-1.5 rounded-md border border-red-200 bg-red-50 px-3 py-2 font-medium text-red-700 text-sm dark:border-red-900/50 dark:bg-red-950/20 dark:text-red-400">
                    <CircleX size={14} />
            ...
            {pendingReviewerCount > 0 && (
                <div className="flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-3 py-2 font-medium text-gray-600 text-sm dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-400">
                    <Clock size={14} />
