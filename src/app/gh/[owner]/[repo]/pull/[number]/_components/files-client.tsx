...
export function FilesSection({
    ...
    return (
        <div>
            <div className="sticky top-0 z-10 bg-surface py-2 pr-2">
                <ActionErrorProvider>
                    <div className="flex min-h-17 items-center justify-between gap-3">
                        ...
                        <div className="flex shrink-0 items-center gap-3">
                            ...
                            <Async
                                fallback={null}
                                promise={
                                    checkRunsPromise ?? EMPTY_ARRAY_PROMISE
                                }
                            >
                                {(checkRuns) => (
                                    <ActionSection
                    ...
                    <ActionErrorBanner className="mt-2" />
                </ActionErrorProvider>
            </div>
            {children}
            {error && (
