// Row geometry mirrors WorkflowRunRow (77px: py-3, 16px icon, 52px body, border-b).
// Each bar is inset inside its text line box (20px / 16px / 16px) so stacked
// lines read as separate lines instead of one block.
            ...
            {SKELETON_ROWS.map((id) => (
                ...
                >
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1.5 h-2.5 w-1/3 animate-pulse rounded bg-surface-selected" />
                        <div className="mt-1.5 h-2.5 w-1/4 animate-pulse rounded bg-surface-selected" />
                    </div>
