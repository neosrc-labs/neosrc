		...
		<div className={`rounded-lg border border-gray-300 ${className}`}>
			...
			{(onSubmit || onCancel) && (
				<div className="flex items-center justify-end gap-2 border-gray-300 border-t px-3 py-2">
					{onCancel && (
						<button
							className="rounded-md border border-gray-300 px-4 py-1.5 font-medium text-gray-600 text-sm transition-colors hover:bg-gray-100 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50"
							disabled={disabled}
							onClick={onCancel}
							type="button"
						>
					...
					{onSubmit && (
						<button
							className="rounded-md bg-[#2da44e] px-4 py-1.5 font-medium text-sm text-white transition-colors hover:bg-[#218838] disabled:cursor-not-allowed disabled:opacity-50"
